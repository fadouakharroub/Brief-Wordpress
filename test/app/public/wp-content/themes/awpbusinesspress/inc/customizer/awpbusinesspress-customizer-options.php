    ...
    'recommended_plugins' => array( 
        'awp-companion' => array(
            ...
            'description' => sprintf( 
                ...
                esc_html__( 'If you want to show all the features and business sections of the FrontPage. please install and activate %s plugin', 'awpbusinesspress' ), '<strong>AWP Companion</strong>' 
            ),
        ),
    ),
